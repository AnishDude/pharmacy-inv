...
import { Eye, EyeOff, Building2, Mail, Shield } from 'lucide-react'
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in to order medicines for your company
          </p>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/customer/register" className="font-medium text-green-600 hover:text-green-500 transition-colors">
        ...
        <div className="text-center">
          <p className="text-sm text-gray-500">
            Are you a pharmacy staff member?{' '}
